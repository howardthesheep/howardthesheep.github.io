(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HuluMoviesComponent = /** @class */ (function () {
                function HuluMoviesComponent(http) {
                    this.http = http;
                    this.baseURL = "http://54.226.171.15:8080/";
                    this.canRender = false;
                }
                HuluMoviesComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.getAllMovies().subscribe(function (mov) {
                        _this.movies = mov;
                        _this.canRender = true;
                        console.log(_this.movies);
                    });
                };
                HuluMoviesComponent.prototype.getAllMovies = function () {
                    return this.http.get(this.baseURL + "movies/hulu").pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) { return response.json(); }));
                };
                return HuluMoviesComponent;
            }());
            HuluMoviesComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/http */ "./node_modules/@angular/http/fesm2015/http.js");
            /* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm2015/operators/index.js");
            var HuluShowsComponent = /** @class */ (function () {
                function HuluShowsComponent(http) {
                    this.http = http;
                    this.baseURL = "http://54.226.171.15:8080/";
                    this.canRender = false;
                }
                HuluShowsComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.getAllShows().subscribe(function (sh) {
                        _this.shows = sh;
                        _this.canRender = true;
                        console.log(_this.shows);
                    });
                };
                HuluShowsComponent.prototype.getAllShows = function () {
                    return this.http.get(this.baseURL + "shows/hulu").pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) { return response.json(); }));
                };
                return HuluShowsComponent;
            }());
            HuluShowsComponent.ctorParameters = function () { return [
                { type: _angular_http__WEBPACK_IMPORTED_MODULE_2__["Http"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MovieComponent = /** @class */ (function () {
                ...
                MovieComponent.prototype.getAllMovies = function () {
                    return this.http.get(this.baseURL + "movies").pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) { return response.json(); }));
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/http */ "./node_modules/@angular/http/fesm2015/http.js");
            /* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm2015/operators/index.js");
            var NetflixMoviesComponent = /** @class */ (function () {
                function NetflixMoviesComponent(http) {
                    this.http = http;
                    this.baseURL = "http://54.226.171.15:8080/";
                    this.canRender = false;
                }
                NetflixMoviesComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.getAllMovies().subscribe(function (mov) {
                        _this.movies = mov;
                        _this.canRender = true;
                ...
                NetflixMoviesComponent.prototype.getAllMovies = function () {
                    return this.http.get(this.baseURL + "movies/netflix").pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) { return response.json(); }));
                };
                return NetflixMoviesComponent;
            }());
            NetflixMoviesComponent.ctorParameters = function () { return [
                { type: _angular_http__WEBPACK_IMPORTED_MODULE_2__["Http"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/http */ "./node_modules/@angular/http/fesm2015/http.js");
            /* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm2015/operators/index.js");
            var NetflixShowsComponent = /** @class */ (function () {
                function NetflixShowsComponent(http) {
                    this.http = http;
                    this.baseURL = "http://54.226.171.15:8080/";
                    this.canRender = false;
                }
                NetflixShowsComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.getAllShows().subscribe(function (sh) {
                        _this.shows = sh;
                        _this.canRender = true;
                ...
                NetflixShowsComponent.prototype.getAllShows = function () {
                    return this.http.get(this.baseURL + "shows/netflix").pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) { return response.json(); }));
                };
                return NetflixShowsComponent;
            }());
            NetflixShowsComponent.ctorParameters = function () { return [
                { type: _angular_http__WEBPACK_IMPORTED_MODULE_2__["Http"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/http */ "./node_modules/@angular/http/fesm2015/http.js");
            /* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm2015/operators/index.js");
            var PrimeMoviesComponent = /** @class */ (function () {
                function PrimeMoviesComponent(http) {
                    this.http = http;
                    this.baseURL = "http://54.226.171.15:8080/";
                    this.canRender = false;
                }
                PrimeMoviesComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.getAllMovies().subscribe(function (mov) {
                        _this.movies = mov;
                        _this.canRender = true;
                ...
                PrimeMoviesComponent.prototype.getAllMovies = function () {
                    return this.http.get(this.baseURL + "movies/prime").pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) { return response.json(); }));
                };
                return PrimeMoviesComponent;
            }());
            PrimeMoviesComponent.ctorParameters = function () { return [
                { type: _angular_http__WEBPACK_IMPORTED_MODULE_2__["Http"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/http */ "./node_modules/@angular/http/fesm2015/http.js");
            /* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm2015/operators/index.js");
            var PrimeShowsComponent = /** @class */ (function () {
                function PrimeShowsComponent(http) {
                    this.http = http;
                    this.baseURL = "http://54.226.171.15:8080/";
                    this.canRender = false;
                }
                PrimeShowsComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.getAllShows().subscribe(function (sh) {
                        _this.shows = sh;
                        _this.canRender = true;
                ...
                PrimeShowsComponent.prototype.getAllShows = function () {
                    return this.http.get(this.baseURL + "shows/prime").pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) { return response.json(); }));
                };
                return PrimeShowsComponent;
            }());
            PrimeShowsComponent.ctorParameters = function () { return [
                { type: _angular_http__WEBPACK_IMPORTED_MODULE_2__["Http"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SearchComponent = /** @class */ (function () {
                ...
                SearchComponent.prototype.getAllMovies = function () {
                    return this.http.get(this.baseURL + "search?set=movie&name=" + this.message).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) { return response.json(); }));
                };
                SearchComponent.prototype.getAllShows = function () {
                    return this.http.get(this.baseURL + "search?set=show&name=" + this.message).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) { return response.json(); }));
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ShowComponent = /** @class */ (function () {
                ...
                ShowComponent.prototype.getAllShows = function () {
                    return this.http.get(this.baseURL + "shows").pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) { return response.json(); }));
                };
